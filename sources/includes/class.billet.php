...
//==================================================================================================	
	...
	function createpage($pageid,$option){
	...
	//==================================================================================================	
		...
		//==================================================================================================	
			...
			//==================================================================================================	
				...
				$buffer=ereg_replace("#TITRE#","<a href='index.php?billet=".$rowtypepage['id']."'>".$nomTITRE."</a>",$buffer);	
				$buffer=ereg_replace("#CONTENU1#",$zone1,$buffer);	
				$buffer=ereg_replace("#CONTENU2#",$zone2,$buffer);			
				$buffer=ereg_replace("#CONTENU3#",$zone3,$buffer);	
			...
			//==================================================================================================	
						...
						while ($rowCOM = mysql_fetch_array($resCOM)){
							...
							<fieldset>
								<legend>#$nb</legend>
									...
									<p align='right' class='$classadmin'>par <a href='mailto:$email'>$pseudo</a> le ".decodedate($commentdate[0])." à ".$commentdate[1]."</p>
							</fieldset>
							<br/>
							";
							$nb--;
				...
				$buffer=ereg_replace("#INFO#",$commenttxt,$buffer);	
				$buffer.="<br/>";
...
//==================================================================================================	
	function check_date_special($pageid){
...
//==================================================================================================	
	...
	function displayaudio($row){		
		...
		if ($row['option_element']==true){
			$buffer.="<br/><a href=\"$file\" target=\"_top\">Télécharger la musique</a><br/>";
		}
	...
	function displayrss($row){
		...
		if ($file) {
			...
			if(eregi("<item>(.*)</item>",$raw,$rawitems)){
				...
				$link=str_replace("<![CDATA[","",$link[1]);
				$link=str_replace("]]>","",$link);
				
				$title=str_replace("<![CDATA[","",$title[1]);
...
//==================================================================================================	
	...
	function textedisplay($row){
		...
		$buffer=ereg_replace("<p align='left'>","<p align='$alignset'>",$buffer);	
		$buffer=ereg_replace("<p align='center'>","<p align='$alignset'>",$buffer);	
		$buffer=ereg_replace("<p align='right'>","<p align='$alignset'>",$buffer);	
		$buffer=ereg_replace("<p align='justify'>","<p align='$alignset'>",$buffer);	
		$buffer=ereg_replace("<p>","<p align='$alignset'>",$buffer);			
		$buffer=ereg_replace("<br>","<br/>\n",$buffer);	
		$buffer=ereg_replace("<br/>","<br/>\n",$buffer);
		$buffer=ereg_replace("<br />","<br/>\n",$buffer);
		$buffer=ereg_replace("<strong>","<b>",$buffer);	
		$buffer=ereg_replace("</strong>","</b>",$buffer);	
		$buffer=ereg_replace("</p>","</p>\r",$buffer);	
...
//==================================================================================================
	...
	function page1b($signature="",$titre=""){
	...
	function page1b2m($signature="",$titre=""){
		$buffer="<table width=100% border=0 cellspacing='0' cellpadding='5'>";
	...
	function page1m2b($signature="",$titre=""){
		$buffer="<table width=100% border=0 cellspacing='0' cellpadding='5'>";
	...
	function page1m2m3m($signature="",$titre=""){
		$buffer="<table width=100% border=0 cellspacing='0' cellpadding='5'>";
		...
		<table border=\"0\" width=\"100%\" id=\"contenu\" >
			<tr>
				<td class=\"galerie\" align=\"center\" colspan=\"2\">
					".Generate_Contenu::fileformat($file)."<br/>cliquez pour voir ou télécharger le fichier
				</td>
			</tr>
			<tr>
				<td valign=\"top\">
