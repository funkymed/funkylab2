<?php
      ...
      "fr-fr"  => array(
			...
			"es"  => array(
		      "variable"  => array("es-ar","es-bo","es-cl","es-co","es-cr","es-sv","es-ec","es-gt","es-hn","es-mx","es-ni","es-pa","es-py","es-pe","es-pr","en-tt","es-uy","es-ve"),
		       "pays"  => array("Argentine","Bolivie","Chilie","Colombie","Costa Rica","El Salvador","Equateur","Guatemala","Honduras","Mexique","Nicaragua","Panama","Paraguay","P�rou","Puerto Rico","Trinidad","Uruguay","Venezuela"),
		       "langue" => array("Espagnol")
		 ),
		 "en"  => array(
		      "variable"  => array("en-za","en-bz","en-bz","en-gb","en-us","en-au"),
		      "pays"  => array("Afrique du sud","B�lize","Grande Bretagne","Am�rique","Australie"),
		      "langue" => array("Anglais")
		 ),
		 "pt"  => array(
		      "variable"  => array("pt-br","ar-qa"),
		      "pays"  => array("Br�sil","Quatar"),
		      "langue" => array("Portugais")
		 ),
		 "ar"  => array(
		      "variable"  => array("ar-sa","ar-bh","ar-ae","en-au"),
		      "pays"  => array("Arabie Saoudite","Bahre�n","Emirat arabe uni"),
		      "langue" => array("Arabe")
		 ),
		 "de"  => array(
	...
	function listlangue($langue){
		...
		$langue_liste=array(
			'Allemand', 'Anglais','Arabe','Espagnole','Fran�ais','Portugais'
		);
	...
	function dskspace($dir)
  {
	...
	function logaction ($stringlog){
		$stringlog=$stringlog." par ".$_SESSION["funkylab_login"]." le ".date("m/d/Y")." � ".date('H:m:s')."\r\n";
		$datelog=date("m.y");
