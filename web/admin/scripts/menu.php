...
*/
	...
	if (testuseradmin()==true){
		...
		[null,'Administration',null,null,'Gestion des utilisateurs',
			...
			[null,'Base de donn�es','myBackup.php','_blank','BDD'],
		],	
		_cmSplit,
...
//==================================================================================================
		...
		if ($autorisation_session_check[1]=="1"){
			...
			if ($autorisation_session_check[6]=="1"){
				$menu_buffer.=  "[null,'G�rer votre espace internet','index.php?cat=243&list&order=TOUT&orderby=id&page=0',null,'Billet'],";
			}	
		}	
